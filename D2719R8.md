...
>
> ::: add
> The allocation function is selected by overload resolution using the argument list termed _K_ as specified in [over.match.new].
> The selected allocation function is called with arguments in _K_.
> If there are parameters that do not have a corresponding argument in _K_, their default arguments are used instead.
> The resulting list of arguments to call the selected allocation function is termed _L_.
>
> ::: example
> ```cpp
> struct S {
