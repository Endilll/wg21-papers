...
> - [1a.5]{.pnum} The [first]{.rm} [size]{.add} parameter shall have [the non-dependent]{.add} type `std​::​size_t` ([support.types])[. The first parameter]{.rm} [and]{.add} shall not have a default argument.
