...
>
> [Each candidate that is a destroying operator delete ([basic.std.dynamic.deallocation]) is discarded.]{.add}
>
> [2]{.pnum} [Let]{.add}
>
...
> - [1.2]{.pnum} [Otherwise, or if no declarations were found, in the global scope.]{.add}
>
> [If any of the candidates is a destroying operator delete, each candidate that is not a destroying operator delete is discarded.]{.add}
>
> ::: add
> ::: note
...
> [2]{.pnum} [Each candidate that is not a usual deallocation operator ([basic.stc.dynamic.deallocation]) is discarded.]{.add}
>
> ::: add
> ::: note
